...
public class AutonomousAction {
  ...
  public static void registerAutonomousAction(String name, LedController controller, Color color) {
    registerAutonomousAction(name, new SolidLedCommand(controller, color));
  }
