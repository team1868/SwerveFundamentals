...
public enum TagPositions {
  ...
  OFFICIAL_16H5_TAG_5(5, 636.96, 265.74, Consts.SUBSTATION_Z_IN, Consts.BLUE_YAW_DEG),
  ...
  NASA_16H5_TAG_2(
      2, 610.77 + FieldDims.NASA_FIELD_DIMS.xDelta_IN, 42.19, Consts.GRID_Z_IN, Consts.RED_YAW_DEG
  ),
  NASA_16H5_TAG_3(
      3, 610.77 + FieldDims.NASA_FIELD_DIMS.xDelta_IN, 42.19, Consts.GRID_Z_IN, Consts.RED_YAW_DEG
  ),
  NASA_16H5_TAG_4(
      4,
